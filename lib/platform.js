        ...
        .then(function() {
            ...
            self.updateDeviceList().then(function(devices) {
                ...
                devices.forEach(function (device) {
                    let FritzDect440Accessory = require('./accessories/dect440')(Homebridge);

                    if (device.productname == 'FRITZ!DECT 440') {
                        ...
                        if (!accessories.find(function (accessory) {
                            ...
                            if (self.deviceConfig(`${ain}.display`, true)) {
                                console.log(device)
                                accessories.push(new FritzDect440Accessory(self, ain));
                            }
                        }
                    }
                });
                self.log("Fritz!DECT 440 found: %s", self.getArrayString(dect440s));
